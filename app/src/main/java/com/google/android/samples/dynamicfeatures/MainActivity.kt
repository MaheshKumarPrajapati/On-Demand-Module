...
private const val sharingModuleSampleClassname = "$packageName.SharingModuleActivity"
...
class MainActivity : AppCompatActivity() {
    ...
    private val moduleSharing by lazy { getString(R.string.sharing_module) }
    ...
    private val clickListener by lazy {
        View.OnClickListener {
            when (it.id) {
                ...
                R.id.btn_sharing_module -> loadAndLaunchModule(moduleSharing)
    ...
    private fun onSuccessfulLoad(moduleName: String, launch: Boolean) {
        if (launch) {
            when (moduleName) {
                ...
                moduleSharing -> launchActivity(sharingModuleSampleClassname)
    ...
    private fun setupClickListener() {
        ...
        setClickListener(R.id.btn_sharing_module, clickListener)
